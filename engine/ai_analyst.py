...
THRESHOLDS = {
    ...
    "furnace_pressure_high": -5.0,
    "o2_percent_high": 5.5,
    "o2_percent_low": 2.0,
    "tube_health_inspect": 70.0,
    "tube_wall_minimum": 5.5,
    "feedwater_ph_low": 7.5,
    "dissolved_oxygen_high": 50.0,
}
...
TAG_METADATA = {
    ...
    "feedwater_ph": {
        "label": "Feedwater pH",
        "unit": "pH",
        "aliases": ("feedwater ph", "water ph", "ph"),
        "decimals": 2,
        "low_warn": 8.2,
        "low_crit": THRESHOLDS["feedwater_ph_low"],
        "status": "lower",
    },
    "dissolved_oxygen": {
        "label": "Dissolved oxygen",
        "unit": "ppb",
        "aliases": ("dissolved oxygen", "oxygen in feedwater", "do ppb"),
        "decimals": 0,
        "high_warn": 30.0,
        "high_crit": THRESHOLDS["dissolved_oxygen_high"],
        "status": "higher",
    },
    "fuel_flow": {
        "label": "Fuel flow",
    ...
    "furnace_pressure_pa": {
        ...
        "unit": "Pa",
        "aliases": ("furnace pressure", "furnace draft", "draft pressure"),
        "decimals": 1,
        "high_warn": -10.0,
        "high_crit": THRESHOLDS["furnace_pressure_high"],
        "status": "higher",
    },
    "flue_gas_flow_kg_hr": {
        "label": "Flue-gas flow",
        "unit": "kg/hr",
        "aliases": ("flue gas flow", "stack flow"),
        "decimals": 0,
        "low_warn": 1100.0,
        "low_crit": 700.0,
        "status": "lower",
    ...
    "stack_damper_actual_pct": {
        "label": "Stack damper",
        "unit": "%",
        "aliases": ("stack damper", "damper position"),
        "decimals": 0,
    },
    "stack_exit_temp_c": {
        "label": "Stack exit temperature",
        "unit": "C",
        "aliases": ("stack exit temperature", "chimney exit temperature"),
        "decimals": 1,
    },
    "chimney_skin_temp_c": {
        "label": "Chimney skin temperature",
        "unit": "C",
        "aliases": ("chimney skin temperature", "stack skin temperature"),
        "decimals": 1,
        "high_warn": 70.0,
        "high_crit": 85.0,
        "status": "higher",
    ...
    "tube_wall_thickness": {
        ...
        "unit": "mm",
        "aliases": ("tube wall thickness", "wall thickness", "tube wall"),
        "decimals": 3,
        "low_warn": 5.8,
        "low_crit": THRESHOLDS["tube_wall_minimum"],
        "status": "lower",
    },
    "corrosion_rate": {
        "label": "Corrosion rate",
        "unit": "mm/year",
        "aliases": ("corrosion rate", "metal loss rate"),
        "decimals": 3,
        "high_warn": 0.2,
        "high_crit": 0.5,
        "status": "higher",
    ...
    "tube_leak_flow": {
        "label": "Estimated tube leak flow",
        "unit": "kg/hr",
        "aliases": ("tube leak flow", "tube leak", "leak flow"),
        "decimals": 0,
        "high_warn": 50.0,
        "high_crit": 500.0,
        "status": "higher",
