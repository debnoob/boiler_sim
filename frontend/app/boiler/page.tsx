...
export default function BoilerPage() {
  ...
  const rows: Array<{ label: string; value: string }> = [
    ...
    { label: 'Furnace draft', value: fmt(tags?.furnace_pressure_pa, 0, ' Pa') },
    { label: 'Stack damper', value: fmt(tags?.stack_damper_actual_pct, 0, ' %') },
    { label: 'Flue flow', value: fmt(tags?.flue_gas_flow_kg_hr, 0, ' kg/hr') },
